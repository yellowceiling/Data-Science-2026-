...
- Is the bolded response **active** or **passive**? Why?
  - Active because it builds upon the colleague's question and provides an explanation for what happened and what the axes are supposed to mean.
- Is the bolded response **constructive** or **destructive**? Why?
  - Constructive because it conveys positive feedback with the "good catch".
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - Much more appreciated and not put down like the original comment.
...
- Is the bolded response **active** or **passive**? Why?
  - Passive because it does not elaborate on the colleague's actual question that was asked. It simply just moves on to another topic.
- Is the bolded response **constructive** or **destructive**? Why?
  - Constructive because it acknowledges the question and supplies a positive response with the "good catch".
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - Frustrated because the question that was asked was acknowledged but not addressed at all.
...
- Is the bolded response **active** or **passive**? Why?
  - Passive because that response has nothing to do with what is going on in the presentation.
- Is the bolded response **constructive** or **destructive**? Why?
  - Destructive because it portrays no positive emotions and almost feels like walking into a trap if you answer the question wrong.
