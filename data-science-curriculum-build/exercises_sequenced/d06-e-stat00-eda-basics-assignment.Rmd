...
**Observations**: - That hypothesis is wrong because the ideally cut
diamonds are the most numerous ones. In fact, the fair diamonds are the
least numerous.
...
**Observations**: - I can not tell literally anything from this graph
because they all look the same and this graph is very ineffective.
...
**Observations**: - Ideal diamonds are the least expensive of all the
cut diamonds which is very interesting because you would expect them to
be most expensive.
...
**Observations**: - Gemstone cutters may make diamonds with a poorer cut
to increase its carat because 1 carat diamonds are more desirable. The
fair diamonds tend to be 1 carat and have the biggest outliers in carat
size with one being as large as 5 carats.
