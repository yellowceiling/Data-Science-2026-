...
- Airport == ATL isn't going to work because it is calling an object that does not exist and should instead be airport == "ATL" to test if its equal to that string or not.
