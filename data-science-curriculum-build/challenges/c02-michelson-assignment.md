...
\- He seems to have purposefully rounded his answers after doing the
calculations.
...
\- His uncertainty is 100.542 less than his error.
...
Similarities - There is a drop in the measured velocity around June
12-13 in both of the graphs. There is fluctuation in both of the graphs
with some values going above the line. The peaks tend to be in similar
places between the two graphs.
...
- 1st graph: The higher the distinctness, the higher the measurement
  was. The lower the distinctness, the lower the measurement was. It is
  interesting that the better the distinctness, the wider range of
  values. I would expect that a more distinct experiment would narrow
  down the results, not widen them. Michelson’s estimate was above the
  actual velocity, so maybe this accounted for that increase.
