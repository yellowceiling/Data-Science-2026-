...
df_stang_long <-
  df_stang %>%
  pivot_longer(
    names_to = c(".value", "angle"), #what did this do ?????
    names_sep = "_",
...
- Is there “one true value” for the material properties of Aluminum?
  - No. Different alloys have different compositions which means they
    each have their own properties with things like temperature,
    elasticity, ductility, etc. Even within one type of alloy, there is
...
- According to the geom_smooth() plot, as nu increases, elasticity
  increases. As strain increases, the elasticity increases, which makes
  sense because the alloy is being bent more.
- You can answer this question with this plot, but it would also be good
  to look at different visualizations to see if there are any
  interesting patterns that don’t appear in geom_smooth(). There could
  be other things going on that you do not see when you make this plot
  alone.
