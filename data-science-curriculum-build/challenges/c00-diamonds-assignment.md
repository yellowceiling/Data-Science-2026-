...
- There is a ton of variation in price in carat range between 1 - 2.5,
  while there is less variation in price the in carats \<1 and carats
  \>2.5
- There are fewer diamonds with carats \> 2.5
- 1 carat diamonds tend to be less expensive than higher carat diamonds,
  but there are multiple cases where lower carat diamonds are more
  expensive than higher carat diamonds
- Diamonds with carats \> 3 are much rarer, whereas diamond are more
  common between carats 0.5 - 2.3
...
- It is difficult to tell the exact number of Fair - Good quality
  diamonds because the dots are covered by the Very Good - Ideal cuts.
- The higher carat diamonds tend to be less ideal in cut quality, yet
  still more expensive
- The cut quality of smaller diamonds tends to be more towards ideal
- Generally, the more expensive a diamond, the higher quality the cut,
  which is not always the case for diamonds of higher carat
- Lower quality cuts tend to be less expensive
- It is difficult to make clear distinctions because of all of the
  overlapping points

``` r
# trying out feedback about implementing geom_smooth()
diamonds %>%
  ggplot(
    mapping = aes(
      x = carat,
